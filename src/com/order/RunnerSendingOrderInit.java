...
/**
 * Servlet implementation class RunnerSendingOrderInit
 */
@WebServlet("/RunnerSendingOrderInit")
public class RunnerSendingOrderInit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RunnerSendingOrderInit() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 */
		 ...
		 deliveryorders = orderdao.getAllRunnerSendingOrder(runner.getRunnerid()); 
