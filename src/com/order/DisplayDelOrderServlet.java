...
/**
 * Servlet implementation class DisplayDelOrderServlet
 */
@WebServlet("/DisplayDelOrderServlet")
public class DisplayDelOrderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayDelOrderServlet() {
        super();
		...
		// 其中sb为json数据包含了merchantid,address,latitude,longitude,phone,storename,tofgid
		 ...
		 List<Deliveryorder> deliveryorders = new ArrayList<>();
			OrderDao orderdao = new OrderDao();
			 deliveryorders = orderdao.getAllInactiveDelOrder(merchant.getMerchantid());
